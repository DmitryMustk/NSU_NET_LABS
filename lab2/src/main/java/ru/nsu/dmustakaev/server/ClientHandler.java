...
//        }
    ...
    private static void reportSpeed(AtomicLong bytesSinceLastReport, long totalReceived,
        ...
        double instantSpeed = bytesInInterval / (interval / 1000.0);
        double averageSpeed = totalReceived / ((currentTime - startTime) / 1000.0);

        System.out.printf("Instant speed: %.2f bytes/sec, Average speed: %.2f bytes/sec%n", instantSpeed, averageSpeed);
    }
}
